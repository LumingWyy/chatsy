...
class KeFu extends Base
{
    ...
    public function addKeFu()
    {
        if(request()->isPost()) {
            ...
            if (0 != $canMake['code']) {
                return ['code' => -4, 'data' => '', 'msg' => 'システムエラー'];
            }

            if (empty($canMake['data'])) {
                return ['code' => -5, 'data' => '', 'msg' => '担当者の数は上限になっています。管理員に連絡してください'];
            }
            ...
            $param['kefu_avatar'] = '/static/common/images/kefu.png';
    ...
    public function praiseAll()
    {
        if(request()->isAjax()){
            ...
            $end = input('param.end', date('Y-m-d'));
            $base = [
                1 => ['title' => 'とても不満', 'star_total' => 0, 'percent' => '0%'],
                2 => ['title' => '不満', 'star_total' => 0, 'percent' => '0%'],
                3 => ['title' => '普通', 'star_total' => 0, 'percent' => '0%'],
                4 => ['title' => '満足', 'star_total' => 0, 'percent' => '0%'],
                5 => ['title' => 'とても満足', 'star_total' => 0, 'percent' => '0%']
            ];
