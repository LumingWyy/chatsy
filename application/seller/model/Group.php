...
class Group extends Model
{
    ...
    public function addGroup($group)
    {
        try {
            ...
            $has = $this->where('group_name', $group['group_name'])
                ...
                ->findOrEmpty()->toArray();
            if(!empty($has)) {
                return ['code' => -2, 'data' => '', 'msg' => 'グループ名が存在しています'];
            }
        ...
        return ['code' => 0, 'data' => '', 'msg' => 'グループ追加成功'];
    }
    ...
    public function editGroup($group)
    {
        ...
        return ['code' => 0, 'data' => '', 'msg' => 'グループを記入成功'];
    }
    ...
    public function delGroup($groupId)
    {
        ...
        return ['code' => 0, 'data' => '', 'msg' => 'グループ削除成功'];
    }
